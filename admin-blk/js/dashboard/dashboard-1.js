 ...
 var dlabChartlist = function(){
	...
	var chartBar = function(){
		...
		shape: "circle",
			...
			xaxis: {
			 ...
			 categories: ['Jakarta Timur', 'Jakarta Pusat', 'Jakarta Barat', 'Jakarta Utara', 'Jakarta Selatan', 'Banten', 'Cimahi'],
			  labels: {
			   style: {
				  colors: '#3e4954',
				  fontSize: '13px',
	...
	var chartBar3 = function(){
		...
		shape: "circle",
			...
			var chartBar1 = new ApexCharts(document.querySelector("#chartBar3"), options);
			chartBar1.render();
	}
