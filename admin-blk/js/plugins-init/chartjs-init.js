(function($) {
 ...
 var dlabSparkLine = function(){
	...
	var statpeserta = function(){	
		//basic area chart
		if(jQuery('#statpeserta').length > 0 ){
			const statpeserta = document.getElementById("statpeserta").getContext('2d');
    
			statpeserta.height = 100;

			new Chart(statpeserta, {
				type: 'line',
				data: {
					defaultFontFamily: 'Poppins',
